...
<body class="">
        <nav class="navbar navbar-expand-sm fixed-top navbar-dark bg-A_primary">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item <?php if($this->uri->segment(2) == 'blog'){ echo "active";}?>"><a href="<?=base_url('admin/All_Blogs')?>" class="nav-link"><i class="fa fa-blog"></i> All Posts</a></li>
                <li class="nav-item <?php if($this->uri->segment(2) == 'about'){ echo "active";}?>"><a href="<?=base_url('Admin/Logout')?>" class="nav-link"><i class="fa fa-sign-out-alt"></i> Log Out</a></li>
            </ul>
            </div>
        </nav>
